...
export function buildInstagramCodexPrompt(items) {
  ...
  return [
    ...
    'El perfil puede republicar contenido cuyo permalink o autor original pertenezca a otra cuenta; eso no lo convierte en una publicación ajena al perfil configurado.',
    ...
    'La relevancia solo sirve para decidir si una publicación puede destacarse en portada. Toda publicación extraída del perfil configurado debe quedar publicada en el archivo de Instagram, aunque isRelevant sea false.',
